...
public class TodayWeatherFragment extends Fragment {
    ...
    TextView txt_city_name,txt_humidity,txt_pressure,txt_sunrise,txt_sunset,txt_temperature,txt_description,txt_date_time,txt_min_temp,txt_wind;
        ...
        compositeDisposable.add(mService.getWeatherByLatLng(String.valueOf(Common.current_location.getLatitude()),
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_pressure.setText(new StringBuilder(String.valueOf(weatherResult.getMain().getPressure())).append(" ").toString());
                        txt_humidity.setText(new StringBuilder(String.valueOf(weatherResult.getMain().getHumidity())).append(" %").toString());
                        txt_sunrise.setText(Common.convertUnixToHour(weatherResult.getSys().getSunrise()));
                        txt_sunset.setText(Common.convertUnixToHour(weatherResult.getSys().getSunset()));
                        txt_min_temp.setText(new StringBuilder(String.valueOf(weatherResult.getMain().getTemp_min())).append(" °C").toString());
